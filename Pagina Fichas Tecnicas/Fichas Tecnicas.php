...
<!--								<input type="hidden" name="gridValor[]" value="<?//=$Grid3[$i]["IdFicha"]; ?>_<?//=$Grid3[$i]["IdCaracteristica"]; ?>_<?//=$Grid3[$i]["Valor"]; ?>"> -->
								<input type="hidden" name="gridValor[]" value="<?=$Grid3[$i]["IdFicha"]; ?>_<?=$Grid3[$i]["IdCaracteristica"]; ?>">
								<input name="imprimeValor[]" type="text" onBlur="checarNumero(this)" value="<?=$Grid3[$i]["Valor"]; ?>" size="12" >
							</td>
