...
/*
				$SQLGrid="SELECT c.IdFicha, e.Modelo, f.Marca, c.Anio";
				$SQLGrid.=" FROM FichaTecnica c, detFichaTecnica d, catAutomovil e, catMarcas f";
				$SQLGrid.=" WHERE c.IdAutomovil=e.IdAutomovil and e.IdMarca=f.IdMarca";
				$SQLGrid.=" and e.Activo=1 and c.Activo=1 and f.Activo=1 and c.IdFicha='".$datosFicha[0]["IdFicha"]."' order by c.IdFicha";
				$Grid = $conex->ejecutarQuerySQL($SQLGrid);
*/
				if(count($Grid)!=0){
