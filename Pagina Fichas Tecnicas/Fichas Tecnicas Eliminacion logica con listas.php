...
/*			
				foreach ($_GET['dataGrid'] as $Grid3[$i]["Valor"]){     
					echo $Grid3[$i]["Valor"]."<br>"; 
				} 
*/				
				if ($Eliminar=="si"){
					...
					$SQLGrid5.=" and a.Activo=1 and b.Activo=1 and c.Activo=1 and e.Activo=1 and f.Activo=1 and c.IdFicha='".$datosFicha[0]["IdFicha"]."' and d.IdCaracteristica='$Caracteristicas' order by c.IdFicha";
					$Grid5 = $conex->ejecutarQuerySQL($SQLGrid5);
					if(count($Grid5)!=0){
						$SQL="DELETE FROM detFichaTecnica";
						$SQL.=" WHERE idFicha='".$datosFicha[0]["IdFicha"]."' and idCaracteristica='$Caracteristicas'";					
						$EliminaCaracteristca=$conex->ejecutarQuerySQL($SQL);
					}
				}
				$Eliminar="no";	
			}
			...
			if(!(isset($EliminarColor))){
				...
				if ($EliminarColor=="si"){
					...
					$checaColor=$conex->ejecutarQuerySQL($SQL);
					if(count($checaColor)!=0){
						$SQL="DELETE FROM Colores WHERE IdFicha='".$datosFicha[0]["IdFicha"]."' and Color='$Color'";
...
/*
	function validarEliminar(){
		...
		f.hdElementos.value = "";
		for (i=0;i<f.dataGrid.length;i++)
		{
		  var elemento=f.dataGrid[i];
						...
						<tr>	
							<td>
								<table width="70%" border="1" cellpadding="0" cellspacing="0">
									<tr> 
										<td colspan="1"  bgcolor="yellow"><div align="center">Colores Capturados</div></td>
									</tr>
									<tr> 
										<td bgcolor="#669966">
			...
			<tr>	
				<td colspan="2">
					<table width="90%" border="1" cellpadding="0" cellspacing="0">
						<tr> 
							<td colspan="5" bgcolor="yellow"><div align="center">Datos Capturados</div></td>
						</tr>
						<tr> 
