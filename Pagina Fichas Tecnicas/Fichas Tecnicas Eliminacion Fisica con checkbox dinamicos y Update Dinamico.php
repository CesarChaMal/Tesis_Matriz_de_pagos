		...
		if(!(isset($Grabar))){
			...
			if ($Grabar=="si"){
				...
				if(count($Grid)!=0){
					...
					$SQLGrid2.=" and e.Activo=1 and c.Activo=1 and f.Activo=1 and c.IdFicha='".$datosFicha[0]["IdFicha"]."' order by c.IdFicha";
					...
					<table width="90%" border="1" cellpadding="0" cellspacing="0">
						...
						<tr bgcolor="<? echo $color2 ?>"> 
							...
							<td align="center">
								...
								<input type="text" name="imprimeValor[]" size="8" value="<?=$Grid3[$i]["Valor"]; ?>" onBlur="checarNumero(this)">
							</td>
